        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-fractown-accent" style={{ whiteSpace: 'nowrap', display: 'inline-block' }}>₹10L+</div>
              <div className="text-blue-200">Min Investment</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-fractown-accent" style={{ whiteSpace: 'nowrap', display: 'inline-block' }}>8-12%</div>
              <div className="text-blue-200">Expected Returns</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-fractown-accent" style={{ whiteSpace: 'nowrap', display: 'inline-block' }}>50+</div>
